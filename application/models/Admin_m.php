...
//                unset( $cats[ $cat['id'] ] );
    ...
    function get_goods_list( $cat_id ){
        $query = $this->db->query(" SELECT 
                                        goods.id, goods.name, goods.price, `goods`.`hc_goods_id`, `goods`.`hc_sync`,
                                        goods.id AS 'g_id',
    ...
    function upd_goods_info( $id, $data_ar ){
        ...
        return $this->db->query("   UPDATE `goods`
                                    SET
                                        ...
                                        `hc_goods_id`       = '{$data_ar['hc_goods_id']}',
                                        `hc_sync`           = '{$data_ar['hc_sync']}',
                                        `hc_factor`         = '{$data_ar['hc_factor']}'
                                    WHERE
                                        `id` = {$id}
                                    LIMIT 1        
                                ");
