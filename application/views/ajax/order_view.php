...
<div class="ajax_order">
    <table>
        ...
        <tr <? if($summ < 300 ) echo ' style="opacity:0.75;" ' ?> >
            <td>Доставка в другой город</td>
            <td>
                <input type="radio" name="order" value="2" style="width: 20px;" onchange="show_hide_shipping()" <? if($summ < 300 ) echo ' disabled="disabled" ' ?>  />
                <? if($summ < 300 ) echo ' <i>* возможна при сумме заказа от 300 грн.</i> ' ?>
            </td>
        </tr>
    </table>
