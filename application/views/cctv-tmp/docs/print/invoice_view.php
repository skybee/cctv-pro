...
<html>
    <head>
        <title>Счет_<?=$_POST['doc_number']?>_от_<?= str_ireplace(' ', '_', $_POST['date'])?></title>
        <style type="text/css"  >
            @page{
                margin: 2cm;
                width: 19cm;
...
/*                border: 1px #000 solid;*/
    ...
    <body>
        ...
        <table id="head_tbl">
            ...
            <tr>
                <td>Получатель:</td>
                <td style="border-bottom: 1px solid #000"><?=  stripcslashes($_POST['recipient']) ?></td>
            </tr>
        </table>
        
        <center>
            <p id="invoice_number">СЧЕТ № <?=$_POST['doc_number']?> </p>
            <p id="invoice_date"> от <?=$_POST['date']?> </p>
            <p id="invoice_period">Счет действителен в течение 1(одного) банковского дня</p>
        </center>
