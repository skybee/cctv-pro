...
<div class="product-collateral info_page_txt">
    <div class="box-collateral box-description">
        <h1>Создание и печать товарной накладной</h1>
        <div class="std docs_form">

            <form action="/print_docs/prnt_doc/bill/" target="_blank" method="post" id="printcheck_form" enctype="multipart/form-data" >
                ...
                <div id="invoice_input_block">
                    ...
                    Плательщик:
                    <br />
                    <input type="text" name="payer" value="тот же" />
                    <br />
                    Основание:
                    <br />
